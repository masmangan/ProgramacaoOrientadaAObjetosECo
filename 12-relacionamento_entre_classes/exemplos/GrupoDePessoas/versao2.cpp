// versao2.cpp (Roland Teodorowitsch; 19 abr. 2022)
...
class Grupo {
private:
	Pessoa *grupo[MAX_PESSOAS]; // ponteiros com objetos alocados DENTRO da classe
	int numPessoas;
public:
	Grupo() {
		numPessoas = 0;
	...
	bool adiciona(Pessoa &p) {
		...
		grupo[numPessoas++] = new Pessoa(p.obtemNome());
		return true;
	}
