// versao3.cpp (Roland Teodorowitsch; 19 abr. 2022)
...
class Grupo {
private:
	Pessoa *grupo[MAX_PESSOAS]; // ponteiros com objetos alocados FORA da classe
	int numPessoas;
public:
	Grupo() {
		numPessoas = 0;
...
int main() {
	...
	for (int i=0; i<amigos.obtemNumPessoas(); ++i) {
		...
		cout << amigos.obtemPessoa(i)->obtemNome() << endl;
		*/
	}
	return 0;
}
